...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'perosnews', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Personews\\FlowBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Personews\\AccountBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Personews\\UserBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Personews\\NotificationBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Personews\\FlowBundle\\Entity');
        $c->addDriver($b, 'Personews\\AccountBundle\\Entity');
        $c->addDriver($b, 'Personews\\UserBundle\\Entity');
        $c->addDriver($b, 'Personews\\NotificationBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FlowBundle' => 'Personews\\FlowBundle\\Entity', 'AccountBundle' => 'Personews\\AccountBundle\\Entity', 'UserBundle' => 'Personews\\UserBundle\\Entity', 'NotificationBundle' => 'Personews\\NotificationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f3c8ffe2b1cc2e8176fb77c88a6c4be1bbc3ab792e813bb5d0ebe5eb7f4b3440');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Personews\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Personews\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Personews\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Personews\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Personews\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('saidmain01@gmail.com');
        $a->setPassword('06a*/<Sc');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\HomepageBundle/Resources/views'), 'Homepage');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\FlowBundle/Resources/views'), 'Flow');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\AccountBundle/Resources/views'), 'Account');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\OfferBundle/Resources/views'), 'Offer');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\AboutBundle/Resources/views'), 'About');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\PresentationBundle/Resources/views'), 'Presentation');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\Personews\\NotificationBundle/Resources/views'), 'Notification');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HomepageBundle' => 'Personews\\HomepageBundle\\HomepageBundle',
                'FlowBundle' => 'Personews\\FlowBundle\\FlowBundle',
                'AccountBundle' => 'Personews\\AccountBundle\\AccountBundle',
                'OfferBundle' => 'Personews\\OfferBundle\\OfferBundle',
                'AboutBundle' => 'Personews\\AboutBundle\\AboutBundle',
                'PresentationBundle' => 'Personews\\PresentationBundle\\PresentationBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UserBundle' => 'Personews\\UserBundle\\UserBundle',
                'NotificationBundle' => 'Personews\\NotificationBundle\\NotificationBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'perosnews',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_encryption' => 'ssl',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'saidmain01@gmail.com',
            'mailer_password' => '06a*/<Sc',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'saidmain01@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '06a*/<Sc',
            ...
            'fos_user.model.user.class' => 'Personews\\UserBundle\\Entity\\User',
